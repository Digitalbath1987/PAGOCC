<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="VerDetalle_Finanzas.aspx.cs" Inherits="pagoCC2._1.Finanzas.VerDetalle_Finanzas" %>
...
<asp:Button ID="btnaprobar" runat="server" CssClass="btn btn-primary btn-lg" Text="Aprobar" OnClick="btnaprobar_Click" />
...
<asp:Button ID="btnGrabarComentario" runat="server" class="btn btn-secondary"  OnClick="btnComentario_Click" Text="Comentar" ValidationGroup="recibido" />
</span>
</div>    
</div>
</div>
